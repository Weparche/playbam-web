...
function getUpcomingDateOptions(referenceDate: string) {
  ...
  for (let offset = 0; options.length < 4; offset += 1) {
    ...
    if (offset === 0 || day === 6 || day === 0) {
      options.push({
        value: formatInputDate(candidate),
        label: formatShortDate(formatInputDate(candidate)),
      })
    }
  }
...
export default function CreateInvitationPage() {
  ...
  const handleDateChange = (nextDate: string) => {
    setDateTime(buildDateTime(nextDate, time))
  }

  const handleTimeChange = (nextTime: string) => {
    setDateTime(buildDateTime(date || today, nextTime))
  }
    ...
    <>
      ...
      <main className="pb-main pb-main--create">
        <section className="pb-section pb-createStudio">
          <div className="pb-createStudio__shell">
            <header className="pb-createStudio__hero">
              <div className="pb-createStudio__heroCopy">
                <span className="pb-createStudio__eyebrow">Playbam Create</span>
                <h1 className="pb-title pb-createStudio__title">Jedan ekran za cijelu pozivnicu</h1>
                <p className="pb-subtitle pb-createStudio__subtitle">
                  Smjer je sada bliže Partiful create flowu: prvo biraš style preset, zatim naslov i font, a datum ostaje jedno
                  polje koje se otvara iz vlastitog popupa.
                </p>
              </div>

              <Card className="pb-createStudio__heroCard">
                <div className="pb-createStudio__heroMetric">
                  <span className="pb-createStudio__heroMetricValue">Live</span>
                  <span className="pb-createStudio__heroMetricLabel">preview editor</span>
                </div>
                <p className="pb-createStudio__heroNote">
                  Create flow je trenutno otvoren bez logina, a desni rail drži `Theme`, `Effect`, `Settings` i konačni preview
                  na istom pageu.
                </p>
                <div className="pb-createStudio__heroTags">
                  <span className="pb-createStudio__heroTag">Style presets</span>
                  <span className="pb-createStudio__heroTag">Floating date picker</span>
                  <span className="pb-createStudio__heroTag">RSVP mood picker</span>
                </div>
              </Card>
            </header>

            <div className="pb-createStudio__layout pb-createStudio__layout--partiful">
              <div className="pb-createStudio__formRail pb-createStudio__formRail--partiful">
                <Card className="pb-flowCard pb-createStudio__panel">
                  ...
                  <p className="pb-flowCard__text">
                    Ovdje biraš vizualni smjer kao mali live preset, pa odmah ispod fino podešavaš naslov i font bez odlaska na
                    drugi ekran.
                  </p>
                  ...
                  <div className="pb-createStudio__stylePresetRow" aria-label="Style presets">
                    {STYLE_PRESETS.map((preset) => (
                      ...
                      >
                        <span
                          className={`pb-createStudio__stylePresetPoster pb-createStudio__stylePresetPoster--${preset.theme} pb-createStudio__stylePresetPoster--${preset.effect}`}
                        >
                          <span className={`pb-createStudio__stylePresetWord pb-createStudio__stylePresetWord--${preset.font}`}>
                            {celebrantName.trim() || 'Luka'}
                          </span>
                        </span>
                  ...
                  <div className="pb-createStudio__formGrid">
                    <label className="pb-formField">
                      ...
                      <input
                        ...
                        placeholder="npr. Luka slavi 6. rođendan"
                      />
                    </label>
                  ...
                  <div className="pb-createStudio__fontGrid">
                    {TITLE_FONT_OPTIONS.map((option) => (
                      <button
                        key={option.id}
                        type="button"
                        className={`pb-createStudio__fontOption ${titleFont === option.id ? 'is-active' : ''}`}
                        onClick={() => setTitleFont(option.id)}
                      >
                ...
                <Card className="pb-flowCard pb-createStudio__panel">
                  ...
                  <p className="pb-flowCard__text">
                    Na površini imaš samo jedno datum polje. Kad klikneš, otvara se mali floating panel za datum i vrijeme.
                  </p>
                  ...
                  <div className="pb-createStudio__formGrid">
                    <div className="pb-formField pb-createStudio__datePickerField" ref={datePopoverRef}>
                      ...
                      <button
                        type="button"
                        className={`pb-createStudio__datePickerTrigger ${isDatePickerOpen ? 'is-open' : ''}`}
                      ...
                      {isDatePickerOpen ? (
                        <div className="pb-createStudio__datePopover">
                          <div className="pb-createStudio__datePopoverHeader">
                            ...
                            <button
                              type="button"
                              className="pb-createStudio__datePopoverClose"
                          ...
                          <div className="pb-createStudio__quickDateGrid">
                            {quickDateOptions.map((option) => (
                              <button
                                key={option.value}
                                type="button"
                                className={`pb-createStudio__quickDateChip ${date === option.value ? 'is-active' : ''}`}
                    ...
                    <label className="pb-formField">
                      ...
                      <input
                        ...
                        placeholder="npr. Igraonica Jogica"
                      />
                    </label>
                  </div>
                  ...
                  <div className="pb-flowActions">
                    <button
                      type="button"
                      className={`pb-createStudio__plusButton ${showAdditionalOptions ? 'is-open' : ''}`}
                      onClick={() => setShowAdditionalOptions((current) => !current)}
                    >
                        ...
                        <div className="pb-createStudio__chips">
                          {LOCATION_TYPES.map((option) => (
                            <button
                              key={option}
                              type="button"
                              className={`pb-createStudio__chip ${locationType === option ? 'is-active' : ''}`}
                      ...
                      <div className="pb-createStudio__formGrid">
                        <label className="pb-formField">
                          ...
                          <input
                            ...
                            placeholder="Adresa ili kratki opis"
                          />
                        </label>
                        ...
                        <label className="pb-formField">
                          ...
                          <textarea
                            className="pb-input pb-createStudio__textarea"
                            value={message}
              ...
              <aside className="pb-createStudio__previewRail pb-createStudio__previewRail--partiful" aria-label="Theme, effect, settings i preview">
                <div className="pb-createStudio__sticky pb-createStudio__sideStack">
                  <Card className="pb-createPreviewCard">
                    <div className={`pb-createPreviewPhone pb-createPreviewPhone--${coverTheme}`}>
                      <div className={`pb-createPreviewPhone__poster pb-createPreviewPhone__poster--${effectStyle}`}>
                        ...
                        <p className="pb-createPreviewPhone__subtitle">
                          {celebrantName.trim()
                            ? `${celebrantName.trim()} je glavni gost dana`
                            : 'Dodaj ime slavljenika da preview dobije pravi ton.'}
                        </p>
                      </div>

                      <div className="pb-createPreviewPhone__body">
                        <div className="pb-createPreviewPhone__detail">
                          <span className="pb-createPreviewPhone__detailLabel">Datum</span>
                          <strong className="pb-createPreviewPhone__detailValue">{formatPreviewDate(date)}</strong>
                        </div>
                        <div className="pb-createPreviewPhone__detail">
                          <span className="pb-createPreviewPhone__detailLabel">Vrijeme</span>
                          <strong className="pb-createPreviewPhone__detailValue">{formatPreviewTime(time)}</strong>
                        </div>
                        <div className="pb-createPreviewPhone__detail">
                          <span className="pb-createPreviewPhone__detailLabel">Lokacija</span>
                          <strong className="pb-createPreviewPhone__detailValue">{previewLocation}</strong>
                        </div>
                  ...
                  <Card className="pb-flowCard pb-createStudio__panel">
                    <div className="pb-createStudio__sectionHeader">
                      <div>
                        <span className="pb-createStudio__sectionEyebrow">Theme</span>
                        <h2 className="pb-flowCard__title">Poster</h2>
                      </div>
                    </div>
                      ...
                      {COVER_THEMES.map((theme) => {
                        ...
                        return (
                          <button
                            key={theme}
                            type="button"
                            className={`pb-createStudio__themeOption pb-createStudio__themeOption--${theme} ${coverTheme === theme ? 'is-active' : ''}`}
                            onClick={() => setCoverTheme(theme)}
                          >
                            <span className="pb-createStudio__themePreview" aria-hidden="true" />
                            <span className="pb-createStudio__themeCopy">
                              <strong>{option.label}</strong>
                              <span>{option.description}</span>
                            </span>
                          </button>
                  ...
                  <Card className="pb-flowCard pb-createStudio__panel">
                    <div className="pb-createStudio__sectionHeader">
                      <div>
                        <span className="pb-createStudio__sectionEyebrow">Effect</span>
                        <h2 className="pb-flowCard__title">Vizualni sloj</h2>
                      </div>
                    </div>
                    <div className="pb-createStudio__themeGrid">
                      {EFFECT_OPTIONS.map((option) => (
                        <button
                          key={option.id}
                          type="button"
                          className={`pb-createStudio__themeOption ${effectStyle === option.id ? 'is-active' : ''}`}
                          onClick={() => setEffectStyle(option.id)}
                        >
                  ...
                  <Card className="pb-flowCard pb-createStudio__panel">
                    <div className="pb-createStudio__sectionHeader">
                      <div>
                        <span className="pb-createStudio__sectionEyebrow">Settings</span>
                        <h2 className="pb-flowCard__title">RSVP mood</h2>
                      </div>
                    </div>
                    <div className="pb-createStudio__rsvpStyleGrid">
                      {RSVP_STYLE_OPTIONS.map((option) => (
                        <button
                          key={option.id}
                          type="button"
                          className={`pb-createStudio__rsvpStyleOption pb-createStudio__rsvpStyleOption--${option.id} ${rsvpStyle === option.id ? 'is-active' : ''}`}
                          onClick={() => setRsvpStyle(option.id)}
                        >
                          <span className="pb-createStudio__rsvpStylePreview" aria-hidden="true">
                            {RSVP_CHOICES.map((choice) => (
                              <span key={choice.id} className="pb-createStudio__rsvpStyleChip">{option.symbols[choice.id]}</span>
                            ))}
                          </span>
                          <span className="pb-createStudio__fontCopy">
                            <strong>{option.label}</strong>
                  ...
                  <Card className="pb-flowCard pb-createStudio__panel pb-createStudio__panel--final">
                    <div className="pb-createStudio__sectionHeader">
                      <div>
                        <span className="pb-createStudio__sectionEyebrow">Preview</span>
                        <h2 className="pb-flowCard__title">Spremi pozivnicu</h2>
                      </div>
                    </div>
                    <div className="pb-createStudio__summaryGrid">
                      <div className="pb-createStudio__summaryItem">
                        <span className="pb-createStudio__summaryLabel">Naslov</span>
                        <strong className="pb-createStudio__summaryValue">{previewTitle}</strong>
                      </div>
                      <div className="pb-createStudio__summaryItem">
                        <span className="pb-createStudio__summaryLabel">Termin</span>
                        <strong className="pb-createStudio__summaryValue">{formatPreviewDate(date)} · {formatPreviewTime(time)}</strong>
                      </div>
                      <div className="pb-createStudio__summaryItem">
                        <span className="pb-createStudio__summaryLabel">Poster</span>
                        <strong className="pb-createStudio__summaryValue">
                          {themeMeta.label} · {TITLE_FONT_OPTIONS.find((option) => option.id === titleFont)?.label}
                        </strong>
                      </div>
                    </div>

                    <div className="pb-flowActions">
                      <Button variant="amber" type="button" onClick={handleCreate} disabled={saving}>
